page 52204064 "Cheque Clearance"
{
    ...
    SourceTableView = where("Document Type" = const(Clearance));
    ...
    layout
    {
        area(Content)
        {
            ...
            group("Cheque Details")
            {
                ...
                field("Payee Branch"; Rec."Payee Branch")
                {
                    ApplicationArea = Basic, Suite;
                }
                ...
                field("Bouncing Charge"; Rec."Bouncing Charge")
                {
                    ApplicationArea = Basic, Suite;
                }
                field("Express Clearing Charge"; Rec."Express Clearing Charge")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = false;
                }
    ...
    actions
    {
        ...
        area(Processing)
        {
            ...
            action(Archive)
            {
                ...
                trigger OnAction()
                begin
                    IF Confirm(StrSubstNo('You are about to Archive Cheque Clearance No. %1, Do you wish to continue?', Rec."No.")) then begin
    ...
    var
        ...
        PostingType: Option Clear,Bounce,Reopen,Archive;
}
