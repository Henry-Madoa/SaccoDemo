page 52204157 "Member Activations"
{
    ...
    layout
    {
        ...
        area(FactBoxes)
        {
            ...
            part("Attached Documents"; "Document Attachment Factbox")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Attachments';
                SubPageLink = "Table ID" = CONST(Database::"Member Activations"), "No." = FIELD("No.");
            }
            part(Control27; "Pending Approval FactBox")
            {
                ApplicationArea = Basic, Suite;
                SubPageLink = "Table ID" = CONST(Database::"Member Activations"), "Document No." = FIELD("No.");
            ...
            action(Post)
            {
                ...
                begin
                    ...
                    if Confirm('Do you want to reactivate the member') then begin
                        MemberMgt.ActivateMember(Rec."No.");
                    end;
                end;
            }
        }
