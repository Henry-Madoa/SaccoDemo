page 52204235 Liens
{
        ...
        area(Processing)
        {
            ...
            action(Process)
            {
                ...
                begin
                    ...
                    if Rec."Transaction Type" = Rec."Transaction Type"::Unholding then Rec.TestField(Status, Rec.Status::Approved);
                    if Confirm('Do you want to %1 the transaction', false, Rec."Transaction Type") then begin
                        //MemberManagement.PostAmountHolding(Rec."Document No");
                        CurrPage.Close();
                    end;
                end;
            }
    ...
    begin
        ...
        if Rec."Transaction Type" = Rec."Transaction Type"::Holding then
            StyleText := 'Favorable'
        else
