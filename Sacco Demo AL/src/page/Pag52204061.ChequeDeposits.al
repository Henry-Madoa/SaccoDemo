    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the value of the Cheque Type field.', Comment = '%';
                }
                field("Clearance Date"; Rec."Clearance Date")
                {
                    ToolTip = 'Specifies the value of the Clearance Date field.', Comment = '%';
                }
            }
        }
        area(FactBoxes)
    ...
    actions
    {
        ...
        area(Processing)
        {
            group("Request Approval")
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    Visible = ((Rec.Status = Rec.Status::Open) and (not Rec."In-House"));
                    Image = Approve;
                    Promoted = true;
                ...
                action("Send Approval Request")
                {
                    ...
                    Visible = ((Rec.Status = Rec.Status::Open) and Rec."In-House");
