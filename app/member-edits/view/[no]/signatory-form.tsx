...
export function EditSignatoryFormButton({ editNo, signatories, className = 'btn', children, onSaved }: {
  editNo: string;
  signatories: MemberEditSignatory[];
  className?: string;
    ...
    <>
      ...
      {open ? (
        <FormModal
          ...
          onSubmit={async () => {
            const res = await saveEditSignatories(
              editNo,
...
export function EditSignatoryPanel({ editNo, signatories, canManage, onSaved }: {
  editNo: string;
  signatories: MemberEditSignatory[];
  canManage: boolean;
  onSaved?: () => void;
  ...
  return (
    <Card>
      <CardHead title="Signatories" sub="Office bearers authorised to act on this account">
        {canManage ? (
          <EditSignatoryFormButton editNo={editNo} signatories={signatories} className="btn sm ghost" onSaved={onSaved}>
            Manage
          </EditSignatoryFormButton>
        ) : null}
      </CardHead>
      {signatories.length ? (
        <TableWrap>
