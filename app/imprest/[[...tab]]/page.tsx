  ...
  return (
    <>
      ...
      <Card>
        ...
        ) : <EmptyState icon="🧾" title="No staff claims here" sub="An employee claims back money spent on the SACCO's business; once approved it is paid from a bank account or through payroll." />}
      </Card>
    </>
  );
}
...
async function LedgerTab() {
  ...
  return (
    <>
      <Card>
        <CardHead title="Employee balances" sub="What each member of staff owes the SACCO on imprests and advances (negative: what the SACCO owes them)" />
        {balances.length ? (
          <TableWrap>
