    ...
    <>
      ...
      {open ? (
        <FormModal title="New imprest request" wide onClose={() => setOpen(false)} onSubmit={(v) => requestImprest(v, lines)}
          submitLabel="Save" successTitle="Imprest request captured" successDetail={(d) => `${d.no} saved — send it for approval when ready`}>
    ...
    <>
      ...
      {open ? (
        <FormModal title="New petty cash request" wide onClose={() => setOpen(false)} onSubmit={(v) => requestPettyCash(v, lines)}
          submitLabel="Save" successTitle="Petty cash captured" successDetail={(d) => `${d.no} saved — send it for approval when ready`}>
