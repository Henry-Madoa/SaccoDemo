  ...
  return (
    <>
      ...
      <div className="grid split-side-sm">
        <div>
          <Card>
            <CardHead title="Member exit details" />
            <DefinitionList items={[
              ...
              ['Maturity date', exit.maturity_date ? formatDate(exit.maturity_date) : '—'],
              ['Reason', exit.reason || '—'],
          ...
          <Card>
            <CardHead title="Document trail" sub="Who requested and processed this exit, and when" />
            <DefinitionList items={[
