page 52203599 "Virement Budget Request"
{
    PageType = Card;
    SourceTable = "Virement Budget Request";
    ...
    layout
    {
        area(Content)
        {
            group(General)
            {
                ...
                field("Budget Name"; Rec."Budget Code")
                {
                    ApplicationArea = Basic, Suite;
                    ShowMandatory = true;
                }
                field(Description; Rec."Budget Name")
                {
                    ApplicationArea = Basic, Suite;
                }
            ...
            part(Control0001; "Virement Budget Request Lines")
            {
                ApplicationArea = Basic, Suite;
            ...
            group("Audit Trail")
            {
                ...
                field("Pending Approvals Ext"; Rec."Pending Approvals Ext")
                {
                    ...
                    begin
                        Entries.Reset();
                        Entries.SetRange("Table ID", Database::"Virement Budget Request");
        ...
        area(factboxes)
        {
            part("Attached Documents"; "Document Attachment Factbox")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Attachments';
                SubPageLink = "Table ID"=CONST(Database::"Virement Budget Request"), "No."=FIELD("No.");
            }
            part("Approval Entries"; "Customize Approval Entries")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Approval Entries';
                SubPageLink = "Table ID"=CONST(Database::"Virement Budget Request"), "Document No."=FIELD("No.");
            }
    ...
    actions
    {
        area(Processing)
        {
            action(Post)
            {
                ...
                Visible = ((Rec.Status = Rec.Status::Approved) and not Rec.Effected);

                trigger OnAction()
                begin
                    BudgetMngt.PostVirementBudget(Rec);
                    CurrPage.Close();
                end;
            }
            action(DocAttach)
            ...
            group("Request Approval")
            {
                ...
                action(SendApprovalRequest)
                {
                    ...
                    begin
                        ...
                        ApprovalsMgt.OnSendVirementBudgetForApproval(Rec);
                    end;
                }
                action(CancelApprovalRequest)
                {
                    ...
                    begin
                        ...
                        ApprovalsMgt.OnCancelVirementBudgetApprovalRequest(Rec);
                        CurrPage.Close();
            ...
            group("Manual Approval")
            {
                ...
                action(Reopen)
                {
                    ApplicationArea = Suite;
                    Caption = 'Re&open';
                    Enabled = ((Rec.Status = Rec.Status::Approved) and (Rec.Effected = false));
                    Image = ReOpen;
                    Promoted = true;
                    PromotedCategory = Category7;
                    PromotedOnly = true;
