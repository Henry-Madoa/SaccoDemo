page 52203826 "Technical Evaluation Window"
{
    ApplicationArea = All;
    PageType = List;
    SourceTable = "Supplier Technical Evaluation";
        ...
        area(processing)
        {
            action("Submit Evaluation")
            {
                ...
                begin
                    ...
                    if EvaluationCommittee.FindFirst then ProcStoreManagement.IanSubmitTechnicalScore(EvaluationCommittee)
                    else
                    begin
                        EvaluationCommittee.Reset;
