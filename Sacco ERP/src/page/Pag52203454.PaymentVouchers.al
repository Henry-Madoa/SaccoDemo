page 52203454 "Payment Vouchers"
{
    ...
    layout
    {
        area(content)
        {
            repeater(General)
            {
                ...
                field("External Document No"; Rec."Cheque Number")
                {
                    ApplicationArea = Basic, Suite;
                }
                field("External Document Date"; Rec."Cheque Date")
                {
                    ApplicationArea = Basic, Suite;
                }
    ...
    actions
    {
        ...
        area(processing)
        {
            action("Import Schedule")
            {
                ...
                Image = ImportExcel;
                Visible = ((Rec."Payment Type" = Rec."Payment Type"::"Petty Cash Topup") and (Rec.Status = Rec.Status::Approved) and (Rec.Posted = false));
    ...
    procedure AssistEdit(PaymentVoucher: Record "Payment Voucher"): Boolean begin
        with PV do begin
            PV:=Rec;
            GLSetup.Get();
