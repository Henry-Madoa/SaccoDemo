page 52203633 "New Employee List"
{
    ...
    SourceTableView = where("Nature Of Employment"=filter(<>Board), "Employee Status"=FILTER(New), "Nature Of Employment"=filter(<>Board));
    ...
    layout
    {
        ...
        area(factboxes)
        {
            ...
            part(Control7; "Leave Statistics")
            {
                ApplicationArea = Basic, Suite;
                SubPageLink = "No."=FIELD("No.");
            }
