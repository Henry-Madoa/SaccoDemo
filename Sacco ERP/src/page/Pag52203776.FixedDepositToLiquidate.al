page 52203776 "Fixed Deposit-To Liquidate"
{
    ...
    SourceTableView = WHERE("Marked for Liquidation"=CONST(true), Liquidated=CONST(false), "Investment Type"=CONST("Fixed Deposit"));
