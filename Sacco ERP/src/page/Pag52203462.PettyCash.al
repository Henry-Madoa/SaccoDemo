page 52203462 "Petty Cash"
{
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Pending Approvals Ext"; Rec."Pending Approvals Ext")
                {
                    ...
                    begin
                        Entries.Reset();
                        Entries.SetRange("Table ID", Database::"Petty Cash Header");
            ...
            part(Control17; "Petty Cash Details")
            {
                Editable = (Rec.Status = Rec.Status::Open);
                ApplicationArea = Basic, Suite;
    ...
    begin
        ...
        if UserSetup.Get(UserId)then begin
            if UserSetup."Finance Admin" then EmployeeEditable:=true
            else
