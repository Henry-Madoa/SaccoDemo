page 52203770 "Fixed Deposit-Posted"
{
    ...
    SourceTableView = WHERE(Status=CONST(Approved), Posted=CONST(true), "Marked for Liquidation"=CONST(false), Terminated=CONST(false), "Investment Type"=CONST("Fixed Deposit"));
