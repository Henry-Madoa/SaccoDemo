page 52203504 "Leave Reinstatement"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Calender of Interest"; Rec."Calender of Interest")
                {
                    ApplicationArea = Basic, Suite;
                }
                ...
                field("Leave Balance Then"; Rec."Leave Balance Then")
                {
                    ApplicationArea = Basic, Suite;
                }
                field("Days to Reinstatement"; Rec."Days to Reinstatement")
                {
                    ApplicationArea = Basic, Suite;
                }
                field("Justify Reinstatement"; Rec."Justify Reinstatement")
                {
                    ApplicationArea = Basic, Suite;
                }
        ...
        area(processing)
        {
            action("Send Approval Request")
            {
                ...
                begin
                    ...
                    Rec.TestField("Justify Reinstatement");
                    Rec.TestField("Leave Code");
                    Rec.TestField("Days to Reinstatement");
                    if not Confirm('Are you sure you want to send leave reinstatement for approval?')then exit
                    else
                    begin
