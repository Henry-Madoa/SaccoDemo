table 52203692 "Supplier Bank Account"
{
    ...
    fields
    {
        ...
        field(13; "Bank Branch No."; Text[20])
        {
            ...
            TableRelation = "External Bank Branches"."Bank Code" WHERE("Branch Code"=FIELD(Code));
        }
    ...
    begin
        ...
        if not VendorLedgerEntry.IsEmpty then Error(BankAccDeleteErr);
    ...
    procedure GetBankAccountNoWithCheck()AccountNo: Text begin
        AccountNo:=GetBankAccountNo;
        if AccountNo = '' then Error(BankAccIdentifierIsEmptyErr);
    end;
    [Scope('Personalization')]
