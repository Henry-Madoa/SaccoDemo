table 52203555 "Draft G/L Acc. Budget Buffer"
{
    // version BUDGETCaption = 'G/L Acc. Budget Buffer';
    ...
    fields
    {
        ...
        {
            AutoFormatType = 1;
            CalcFormula = Sum("Draft Budget Entry".Amount WHERE("Budget Name"=FIELD("Budget Filter"), "G/L Account No."=FIELD("G/L Account Filter"), "Business Unit Code"=FIELD("Business Unit Filter"), "Global Dimension 1 Code"=FIELD("Global Dimension 1 Filter"), "Global Dimension 2 Code"=FIELD("Global Dimension 2 Filter"), "Budget Dimension 1 Code"=FIELD("Budget Dimension 1 Filter"), "Budget Dimension 2 Code"=FIELD("Budget Dimension 2 Filter"), "Budget Dimension 3 Code"=FIELD("Budget Dimension 3 Filter"), "Budget Dimension 4 Code"=FIELD("Budget Dimension 4 Filter"), Date=FIELD("Date Filter")));
    ...
    var Text000: Label '1,6,,Budget Dimension 1 Filter';
    ...
    local procedure GetCaptionClass(BudgetDimType: Integer): Text[250]begin
        if GLBudgetName.Name <> GetFilter("Budget Filter")then GLBudgetName.Get(GetFilter("Budget Filter"));
