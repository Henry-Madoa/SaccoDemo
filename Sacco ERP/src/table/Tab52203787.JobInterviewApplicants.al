table 52203787 "Job Interview Applicants"
{
    DrillDownPageID = "Job Interview Applicants";
    LookupPageID = "Job Interview Applicants";
    Caption = 'Interview Applicants';
    ...
    fields
    {
        ...
        field(14; "Interview Venue"; Text[250])
        {
        }
        field(15; "Interview Date"; Date)
        {
        }
        field(16; "Interview Time"; Time)
        {
        }
        field(17; Qualified; Boolean)
        {
        }
    }
    keys
