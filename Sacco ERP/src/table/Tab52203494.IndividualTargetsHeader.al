table 52203494 "Individual Targets Header"
{
    fields
    {
        ...
        field(29; "Overall Score"; Decimal)
        {
    ...
    HRAppraisalJournalLine: Record "Appraisal Journal Line";
    URL: Text[500];
    HRPeriods: Record "Appraisal Calender";
    HRJournalBatch: Record "Leave Journal Batch";
    intEntryNo: Integer;
    "LineNo.": Integer;
    HRIndividualTargetLine: Record "Individual Target Line";
    AppraisalPeriod: Record "Appraisal Calender";
