codeunit 52203474 "Probation Ending Period"
{
    trigger OnRun()
    begin
        ...
        if CombinedGeneratedString <> '' then begin
            ...
            if UserSetup.FindSet then begin
                repeat Employee.Reset;
                    ...
                    Body:='Hello ' + Employee.FullName + '<br> The Following employee(s) probation periods are due to expire in <b>' + Format(HumanResourcesSetup."Probation Notifications") + '(s)</b> Time<br> Kidnly take them through confirmation appraisal and submit ' + ' results by ' + Format(CalcDate('1W', Today)) + CombinedGeneratedString + '<br> This is a system generated email please do not reply to it <br> Regards';
