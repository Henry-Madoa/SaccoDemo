report 52203531 "SHIF Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ssrs/SHIF Report.rdlc';
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            RequestFilterFields = "No.", "Global Dimension 6 Code";
            ...
            begin
                ...
                if PrPeriodTrans.FindSet then repeat if PrPeriodTrans."Transaction Code" = 'SHIF' then SHIFAmount:=PrPeriodTrans.Amount;
            ...
            begin
                ...
                EmployerPin:=CompanyInformation."VAT Registration No.";
