report 52203432 "Generate Receipts Journal"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ssrs/Generate Receipts Journal.rdlc';

    dataset
    {
        dataitem("Receipts Tx"; "Receipts Tx")
        {
            trigger OnAfterGetRecord()
            begin
                GenJnLine.Init;
                GenJnLine."Journal Template Name":='GENERAL';
                GenJnLine."Journal Batch Name":='TRANS';
                ...
                GenJnLine."Document No.":='RX-' + Format("Receipts Tx"."Line No");
            ...
            begin
                ...
                GenJnLine.SetRange(GenJnLine."Journal Batch Name", 'TRANS');
                GenJnLine.DeleteAll;
                Batch.Init;
                Batch."Journal Template Name":='GENERAL';
                Batch.Name:='TRANS';
                if not Batch.Get('GENERAL', 'TRANS')then Batch.Insert;
                LineNo:=10000;
            end;
        }
    }
