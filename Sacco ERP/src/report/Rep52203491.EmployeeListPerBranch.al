report 52203491 "Employee List Per Branch"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ssrs/Employee List Per Branch.rdlc';

    dataset
    {
        dataitem(Employee; Employee)
        {
            RequestFilterFields = "Global Dimension 2 Code", "Global Dimension 1 Code";
