report 52203455 "Store Requisition Summary"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ssrs/Store Requisition Summary.rdl';

    dataset
    {
        dataitem(RequisitionHeader; "Requisition Header")
        {
            RequestFilterFields = "Global Dimension 1 Code", "Location Code", Status;
            ...
            column(Date; RequisitionHeader."Requisition Date")
            {
            }
            column(No; RequisitionHeader."No.")
            {
            }
            column(Employee_Name; "Employee Name")
            {
            }
            column(Description; RequisitionHeader.Description)
            {
            }
            column(Global_Dimension_1_Code; RequisitionHeader."Global Dimension 1 Code")
            {
            }
            column(Global_Dimension_2_Code; RequisitionHeader."Global Dimension 2 Code")
            {
            }
            column(Location_Code; RequisitionHeader."Location Code")
            {
            }
            ...
            column(Store_Req__Qty__Approved; "Store Req. Qty. Approved")
            {
            }
            column(Store_Req__Qty__Issued; "Store Req. Qty. Issued")
            {
            }
            ...
            begin
                ...
                ApprovalEntries.SetRange(ApprovalEntries."Document No.", RequisitionHeader."No.");
