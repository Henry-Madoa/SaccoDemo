report 52203564 "Employee Contact List"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ssrs/Employee Contact List.rdl';
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            begin
                ...
                if DimValue.Get('DEPARTMENT', Employee."Global Dimension 1 Code")then Department:=DimValue.Name;
            end;
