report 52203582 "Appraisal Perfomance History"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ssrs/Appraisal Perfomance History.rdl';

    dataset
    {
        dataitem("Appraisal Header"; "Appraisal Header")
        {
            RequestFilterFields = "Employee No", "Level/Grade", "Global Dimension 1 Code";
            ...
            column(AppraisalPeriod_AppraisalHeader; AppraisalPeriodName)
            {
            }
