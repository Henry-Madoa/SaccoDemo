table 52204138 "Archived PesaLink Transactions"
{
    DrillDownPageId = "Archived Pesalink Transactions";
    LookupPageId = "Archived Pesalink Transactions";
    fields
    {
        ...
        field(18; "Payment Refrence Code"; Text[100]) { }
    }
