page 52204078 "Treasury Returns"
{
    ...
    CardPageId = "Treasury Return";
    SourceTableView = where("Document Type" = const("Treasury Return"));
    ModifyAllowed = false;
    Editable = false;
    ...
    begin
        Rec."Document Type" := Rec."Document Type"::"Treasury Return";
    end;
