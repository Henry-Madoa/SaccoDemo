page 52204026 "Member Account Deactivation"
{
    ...
    SourceTableView = where("Document Type" = filter(Deactivation));
    ...
    layout
    {
        area(Content)
        {
            group(General)
            {
                ...
                field("Deactivation Reason"; Rec."Deactivation Reason")
                {
                    ApplicationArea = Basic, Suite;
                    MultiLine = true;
                    ShowMandatory = true;
                    ...
                    begin
                        ...
                        if Page.RunModal(Page::"Blocked Reasons", BloackedReason) = ACTION::LookupOK then Rec."Deactivation Reason" := BloackedReason.Description;
                    end;
                }
            }
    ...
    begin
        Rec."Document Type" := Rec."Document Type"::Deactivation;
    end;
