page 52204269 "Share Capital Transfers"
{
            ...
            action(Post)
            {
                ...
                begin
                    if Confirm('Do you want to Post?') then
                        FosaMgt.PostInterAccountTransfer(Rec."No.");
                end;
            }
        }
    }
    ...
    begin
        Rec."Document Type" := Rec."Document Type"::"Share Capital";
    end;
