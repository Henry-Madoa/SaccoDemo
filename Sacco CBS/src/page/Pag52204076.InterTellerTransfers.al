page 52204076 "Inter Teller Transfers"
{
    ...
    CardPageId = "Inter Teller Transfer";
    SourceTableView = where("Document Type" = const("Inter Teller Transfer"));
    Editable = false;
    ModifyAllowed = false;
    ...
    begin
        Rec."Document Type" := Rec."Document Type"::"Inter Teller Transfer";
    end;
