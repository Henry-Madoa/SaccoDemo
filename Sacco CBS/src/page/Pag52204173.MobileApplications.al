    ...
    layout
    {
        ...
        area(FactBoxes)
        {
            ...
            part("Attached Documents"; "Document Attachment Factbox")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Attachments';
                SubPageLink = "Table ID" = CONST(Database::"Mobile Application"), "No." = FIELD("No.");
            }
            ...
            part("Approval Entries"; "Customize Approval Entries")
            {
                ...
                SubPageLink = "Table ID" = CONST(Database::"Mobile Application"), "Document No." = FIELD("No.");
            }
    ...
    actions
    {
        area(Processing)
        {
            ...
            action("Post Application")
            {
                ...
                begin
                    MemberMgt.PostMobileApplication(Rec."No.");
                end;
            }
        }
    }
