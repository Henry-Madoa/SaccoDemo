page 52204265 "FOSA Dividends"
{
        ...
        area(processing)
        {
            ...
            action("Import Balances")
            {
                ...
                begin
                    ...
                    if DividendDetEntries.FindFirst then begin
                        if CONFIRM('Do you want to Ovewrite?') then DividendDetEntries.DELETEALL;
                    end;
                    COMMIT;
            ...
            action("Import Calculations")
            {
                ...
                begin
                    DividendDetEntries.RESET;
                    DividendDetEntries.SETRANGE("Dividend Code", Rec."No.");
                    if DividendDetEntries.FINDFIRST then DividendDetEntries.DELETEALL;
                    COMMIT;
            ...
            action("Send SMS Notifications")
            {
                ...
                trigger OnAction()
                begin
                    if CONFIRM('Do you want to Send SMS Notifications?') then DividendManagement.SendSMSNotifications(Rec);
                end;
            }
    ...
    begin
        Rec."Document Type" := Rec."Document Type"::FOSA;
    end;
