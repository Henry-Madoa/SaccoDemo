page 52204033 "Collateral Releases"
{
    ...
    layout
    {
        area(Content)
        {
            repeater("General")
            {
                ...
                field(Collateral; Rec."Collateral Code")
                {
                    ApplicationArea = Basic, Suite;
                }
        ...
        area(factboxes)
        {
            ...
            part("Attached Documents"; "Document Attachment Factbox")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Attachments';
                SubPageLink = "Table ID" = CONST(Database::"Collateral Release"), "No." = FIELD("No.");
            }
            part(Control27; "Pending Approval FactBox")
            {
                ApplicationArea = Basic, Suite;
                SubPageLink = "Table ID" = CONST(Database::"Collateral Release"), "Document No." = FIELD("No.");
    ...
    actions
    {
        ...
        area(Processing)
        {
            ...
            action(Post)
            {
                ...
                trigger OnAction()
                begin
                    if not Confirm('Do you want to release?') then exit;
