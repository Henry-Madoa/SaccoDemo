    ...
    layout
    {
        ...
        area(FactBoxes)
        {
            ...
            part("Attached Documents"; "Document Attachment Factbox")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Attachments';
                SubPageLink = "Table ID" = CONST(Database::"Bankers Cheque"), "No." = FIELD("No.");
            }
            part(Control27; "Pending Approval FactBox")
            {
                ApplicationArea = Basic, Suite;
                SubPageLink = "Table ID" = CONST(Database::"Bankers Cheque"), "Document No." = FIELD("No.");
            ...
            action(Post)
            {
                ...
                begin
                    if Confirm('Do you want to Post?') then begin
                        FOSAManagement.PostBankersCheque(Rec);
                        CurrPage.Close();
                    end;
                end;
            }
