 ...
 */
export function EditableCard({ title, sub, canEdit, form, badge, collapsible = false, children }: {
  title: ReactNode;
  sub?: ReactNode;
  ...
  if (collapsible) {
    return <CollapsibleCard title={title} sub={sub} actions={actions}>{body}</CollapsibleCard>;
  }
  return (
    <Card>
