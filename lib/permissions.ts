...
export const PAGES: PageObject[] = [
  ...
  { code: 'ADMIN_PRODUCTS_SALARY_PARAMS', label: 'Salary Appraisal Parameters', route: '/admin/pool/credit/salary-params' },
  { code: 'ADMIN_PRODUCTS_EMPLOYERS', label: 'Employers', route: '/admin/pool/finance/employers' },
